			...
			if($resCliente !== false){
				...
				if ($gpsSignalIndicator != 'L' && !empty($latitudeDecimalDegrees)) {
					...
					*/
					...
					mysql_query("UPDATE bem set date = convert_tz(now(), 'GMT', 'Brazil/East'), status_sinal = 'S' WHERE imei = '$imei'", $con);
				}
