...
// $query = "
// 	select date_format(date,'%d/%m/%Y %h:%i:%s') as data, imei, ROUND(latitudeDecimalDegrees,5) AS latitudeDecimalDegrees, ROUND(longitudeDecimalDegrees,5) AS longitudeDecimalDegrees, latitudeHemisphere, longitudeHemisphere, 
...
// 	 GROUP BY latitudeDecimalDegrees
// 	 order by date asc
// 	 limit ".$limite." 
// ";

$query = "select date_format(date,'%d/%m/%Y %h:%i:%s') as data, imei,latitudeDecimalDegrees, longitudeDecimalDegrees, latitudeHemisphere, longitudeHemisphere, 
	       km_rodado, address, speed as velocidade, converte, ligado
	  from gprmc where imei = '$imei' 
	   and date between '$dataInicio ". formataHora($hrDataInicio, $mnDataInicio) ."' and '$dataFinal ". formataHora($hrDataFinal, $mnDataFinal) ."'
	 GROUP BY latitudeDecimalDegrees
