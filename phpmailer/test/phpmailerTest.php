...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Mail->Helo = 'cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com.localdomain';
    ...
    public function checkChanges()
    {
        ...
        if ($this->Mail->Helo != 'cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com.localdomain') {
...
EOT;
    ...
    public function testPopBeforeSmtpGood()
    {
        ...
        $this->assertTrue(
            POP3::popBeforeSmtp('cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com', 1100, 10, 'user', 'test', 0),
    ...
    public function testPopBeforeSmtpBad()
    {
        ...
        $this->assertFalse(
            POP3::popBeforeSmtp('cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com', 1101, 10, 'user', 'xxx', 0),
    ...
    public function testSmtpConnect()
    {
        ...
        $this->Mail->smtpClose();
        $this->Mail->Host = "ssl://cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com:12345;tls://cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com:587;10.10.10.10:54321;cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com:12345;10.10.10.10";
        $this->assertFalse($this->Mail->smtpConnect(), 'SMTP bad multi-connect succeeded');
        $this->Mail->smtpClose();
        $this->Mail->Host = "cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com:12345;10.10.10.10:54321;" . $_REQUEST['mail_host'];
        $this->assertTrue($this->Mail->smtpConnect(), 'SMTP multi-connect failed');
        $this->Mail->smtpClose();
        $this->Mail->Host = " cloudservice.cgejdsdl842e.sa-east-1.rds.amazonaws.com:12345 ; " . $_REQUEST['mail_host'] . ' ';
