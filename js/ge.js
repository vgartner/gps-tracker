...
function GoogleEarth(map) {
  ...
  //this.RED_ICON_ = 'http://gps.webarch.com.br/imagens/ultimo_local.png';
...
GoogleEarth.prototype.addEarthEvents_ = function() {
  ...
  // add some layers
  var layergpstracker = ge.getLayergpstracker();
  layergpstracker.enableLayerById(ge.LAYER_BORDERS, true);
  layergpstracker.enableLayerById(ge.LAYER_ROADS, true);
